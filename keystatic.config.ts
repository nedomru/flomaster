...
export default config({
    ui: {
        ...
        navigation: {
            ...
            "Продажи": ['sales/paid-help', '/phrases/sales/tariffs', 'sales/routers', 'sales/decoders', 'sales/camcorders'],
    ...
    collections: {
        ...
        '/phrases/sales/tariffs': createCollection('Тарифы', '/phrases/sales/tariffs'),
